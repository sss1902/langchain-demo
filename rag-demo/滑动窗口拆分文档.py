...
def split_text_with_overlap(text, chunk_size=150, overlap_size=40):
    """
    使用滑动窗口进行文本拆分，保证chunk之间的语义连续
    :param text:
    :param chunk_size:
    :param overlap_size:
    :return:
    ...
    while start < text_length:
        ...
        # 核心 避免添加空chunk或者短chunk
        if chunk:
            chunks.append(chunk)

        # 滑动窗口关键逻辑 如果下一个start超过文本长度 直接退出
...
# 测试
chunks = split_text_with_overlap(LONG_DOCUMENT)
